 ...
 * das palavras for igual, deve-se ordernar por ordem alfabética.
 * 
 * Entrada A primeira linha da entrada possui um único inteiro N, que indica o
 * número de casos de teste. Cada caso de teste poderá conter de 1 a 50 palavras
 ...
 * 
 * Saída A saída deve conter o conjunto de palavras da entrada ordenado pelo
 * tamanho das palavras e caso o tamanho das palavras for igual, deve-se
 * ordernar por ordem alfabética.. Um espaço em branco deve ser impresso entre
 * duas palavras.
 * 
